      ...
      <div class="container mx-auto flex justify-between items-center relative">
        ...
        <ul class="flex space-x-4 items-center">
          ...
          <li class="hidden sm:block">
            <p @click="scrollToSection" class="px-4 cursor-pointer py-2 font-semibold text-lg hover:bg-yellow-300 hover:rounded-md hover:text-black">
      Home
    </p>
          ...
          <li class="hidden sm:block">
            <a href="/saveJobs" class="px-4 py-2 font-semibold text-lg hover:text-yellow-300">Program</a>
          </li>
